...
def run_phase(label, left_cmd, right_cmd):
    ...
    while time.time() - t0 < DURATION:
        ...
        # set_motors(left_cmd+added_to_cmd, right_cmd+added_to_cmd)
        # print(f"Motor command sent: L={left_cmd+added_to_cmd} R={right_cmd+added_to_cmd}")
        # added_to_cmd += 1  # Gradually increase command to test higher speeds
